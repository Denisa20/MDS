...
if (isset($_POST['cuvinte']) && $_POST['cuvinte']!="") {
	$words = $_POST['cuvinte'] ;
  } else {
	$words = "dummy";
  }
...
$sql = "SELECT * FROM produse WHERE nume LIKE \"%".$words."%\" ";		
$resursa = mysqli_query($GLOBALS['con'], $sql);

$total = mysqli_num_rows($resursa); 
if ($total==0)  {echo "<h2>Cautarea dumneavoastra nu a returnat nici un rezultat !</h2>";}
?>
