...
$sql = "SELECT * FROM produse,categorii WHERE produse.idc=categorii.idc AND produse.idc=".$idc;		
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>		
								...
								<td width="218" height="103" align="center"><br style="line-height:9px">																
								   <?php 
										print '<a href="details.php?id='.$row['id'].'"><img src="products/'.$row['id'].'/1.jpg" height="86" border="0"></a>';
									?>																																																						
										<br>													
								</td>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td width="197" height="45" style="vertical-align:middle">
									<?php echo $row['nume']; ?>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="101" height="53" align="center" style="vertical-align:middle">
									<span><?php echo $row['pret']; ?> RON</span>
								</td>
