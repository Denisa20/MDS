...
if (isset($_SESSION['nr_produse'])) 
	{ 
		$nr_produse = $_SESSION['nr_produse']; 
	} 
else 
	{ 
		$_SESSION['nr_produse'] = array(); 
		$nr_produse = 0;
	}

if (isset($_SESSION['pret'])) 
	{ 
		$nr_produse = $_SESSION['pret']; 
	} 
else 
	{ 
		$_SESSION['pret'] = array(); 
...
if (!isset($_SESSION['nr_loc_rez'])) 
	$_SESSION['nr_loc_rez'] = array();
