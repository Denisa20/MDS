...
if (isset($_SESSION['valid_client'])&& $_SESSION['valid_client']!= array())  {
   echo 'Bine ai venit <b style="color:#000;">'.$_SESSION['valid_client'].'</b><br>';
	...
	echo "<a href=\"login_page.php\" style=\"font-weight:bold; size:20px;\">Log in</a> <br> <a href=\"http://localhost/pc/login_page.php?action=creaza\" style=\"font-weight:bold; size:20px;\">Register</a>";
}
