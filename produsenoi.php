...
$sql = "SELECT * FROM produse WHERE id>50 AND id<80 ORDER BY pret DESC LIMIT 0,6";		
																					...
																					<table cellpadding="0" cellspacing="0" border="0">
																						<tr>
																							...
																							<td width="117" height="53">
																								<a href=<? echo "details.php?id=".$row['id']; ?> ><img src="images/button_details.gif" alt="" border="0"></a><br>
